...
class CsItemAdapter(private val context: Context): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    init {
        ...
        firestore?.collection("NoteTaking")?.document("Subjects")?.collection("CS")?.whereEqualTo("uid", auth.currentUser?.uid)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind(Item : item){
            itemView.setOnClickListener {
                Intent(context, CsNoteViewActivity::class.java).apply {
