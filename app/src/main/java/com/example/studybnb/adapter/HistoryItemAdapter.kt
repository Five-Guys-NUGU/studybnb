...
import com.example.studybnb.history.HistoryNoteViewActivity
...
class HistoryItemAdapter(private val context: Context): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind(Item : item){
            itemView.setOnClickListener {
                Intent(context, HistoryNoteViewActivity::class.java).apply {
